...
describe("runtime governance contract", () => {
  it("keeps hook manifests, profiles, and compatibility data aligned", async () => {
    ...
    expect(flowArtifactIds.has("recursive-runtime-root-frame")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-iteration")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-action-bundle")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-subcall")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-checkpoint")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-code-cell")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-promotion")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-meta-op")).toBe(true);
    expect(flowArtifactIds.has("recursive-runtime-scorecard")).toBe(true);
    ...
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-action-bundle.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-iteration.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-subcall.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-memory.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-checkpoint.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-final-output.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-code-cell.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-promotion-proposal.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-meta-op-proposal.schema.json");
    expect(packageSurface.requiredPaths).toContain("schemas/runtime/recursive-scorecard.schema.json");
