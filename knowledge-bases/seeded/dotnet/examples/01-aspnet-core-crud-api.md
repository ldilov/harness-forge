...
Use this playbook when the task is primarily about: Minimal API or controller-based endpoints, validation, persistence seams, OpenAPI, and cancellation propagation.
