...
Use this playbook when the task is primarily about: Domain models, value objects, boundary-safe serialization, and testable business logic without framework leakage.
