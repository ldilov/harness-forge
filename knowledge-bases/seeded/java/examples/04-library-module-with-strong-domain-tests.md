...
Use this playbook when the task is primarily about: Pure domain logic, contract-heavy APIs, and tests that cover invariants instead of framework ceremony.
