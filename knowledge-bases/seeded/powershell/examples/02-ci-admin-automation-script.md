...
Use this playbook when the task is primarily about: Strict mode, exit codes, secret handling, deterministic logging, and non-interactive execution in build agents.
