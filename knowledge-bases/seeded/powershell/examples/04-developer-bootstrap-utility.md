...
Use this playbook when the task is primarily about: Machine setup orchestration, prerequisite checks, repairable steps, and stable local developer experience.
