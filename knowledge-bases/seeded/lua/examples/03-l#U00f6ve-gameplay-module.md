...
Use this playbook when the task is primarily about: State update/draw separation, deterministic simulation, asset boundaries, and debug instrumentation.
...
## Validation path
- lint
- unit or harness tests
- runtime smoke
- sandbox/host compatibility
- error-path review
