...
**Tests**: The examples below include test tasks. Tests are REQUIRED whenever a
story changes behavior, fixes a bug, adds an interface, or changes an integration
contract. Omit them only when the specification or plan explicitly justifies why
executable verification is not applicable.
...
- [ ] T004 [P] Configure the strongest available automated verification for the
      target stack (tests, type checks, contract checks, or equivalent)
...
- [ ] T011 Define module boundaries, contracts, and adapter seams shared by all
      stories
...
- [ ] T019 [US1] Add observability for user story 1 operations
- [ ] T020 [US1] Update affected docs and agent guidance for user story 1
...
- [ ] T027 [US2] Update observability and docs for user story 2
...
- [ ] T033 [US3] Update observability and docs for user story 3
...
- [ ] TXXX [P] Sync agent guidance files affected by architecture or command changes
