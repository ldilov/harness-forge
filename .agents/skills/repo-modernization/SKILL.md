...
- trigger when a repo has dependency drift, outdated frameworks, weak validation, or repeated delivery pain
- trigger when the right answer is a staged modernization plan instead of an immediate rewrite
